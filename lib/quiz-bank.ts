...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  ...
  },
  {
    ...
    options: ['23 pasang (46)', '20 pasang (40)', '24 pasang (48)', '22 pasang (44)'],
    correctIndex: 0,
  ...
  },
  {
    ...
    options: ['Mengkristal (Deposisi)', 'Menyublim', 'Mengembun', 'Membeku'],
    correctIndex: 0,
  ...
  // Kategori: Logika & Matematika
  {
    id: 'l-1',
    category: 'Logika',
    question: 'Jika 3 kucing dapat menangkap 3 tikus dalam 3 menit, berapa menit yang dibutuhkan 100 kucing untuk menangkap 100 tikus?',
    options: ['100 menit', '3 menit', '30 menit', '1 menit'],
    correctIndex: 1,
    explanation: 'Setiap 1 kucing membutuhkan waktu 3 menit untuk menangkap 1 tikus secara bersamaan.'
  },
  {
    id: 'l-2',
    category: 'Logika',
  ...
  },
  {
    id: 'l-3',
    category: 'Logika',
    question: 'Kelanjutan deret angka berikut: 2, 4, 8, 16, 32, ... adalah?',
    options: ['48', '64', '56', '72'],
    correctIndex: 1,
  ...
  },
  {
    id: 'l-4',
    category: 'Logika',
    question: 'Sebuah kolam memiliki teratai yang melipatgandakan luasnya tiap hari. Di hari ke-20 kolam penuh. Di hari ke berapa kolam terisi separuh?',
    options: ['Hari ke-10', 'Hari ke-15', 'Hari ke-19', 'Hari ke-18'],
    correctIndex: 2,
    explanation: 'Karena berlipat ganda tiap hari, sehari sebelum penuh (hari ke-19) luasnya adalah separuh kolam.'
  },
  {
    id: 'l-5',
    category: 'Logika',
    ...
    options: ['21', '27', '29', '35'],
    correctIndex: 2,
    explanation: '29 hanya habis dibagi oleh angka 1 dan dirinya sendiri (29).'
  },
  {
    id: 'l-6',
    category: 'Logika',
    question: 'Ibu Budi punya 4 anak: Timur, Barat, Selatan. Siapakah nama anak keempat?',
    options: ['Utara', 'Tenggara', 'Budi', 'Barat Laut'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Tiongkok', 'Korea Selatan', 'Jepang', 'Thailand'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Euro', 'Poundsterling', 'Dolar', 'Franc'],
    correctIndex: 1,
    explanation: 'Poundsterling (£/GBP) adalah salah satu mata uang tertua yang masih aktif digunakan.'
  },
  {
    id: 'u-6',
    category: 'Umum',
    question: 'Hewan mamalia darat terbesar yang masih hidup adalah...',
    options: ['Badak Putih', 'Gajah Afrika', 'Jerapah', 'Kuda Nil'],
    correctIndex: 1,
    explanation: 'Gajah semak Afrika jantan dewasa dapat memiliki berat mencapai 6.000 kg.'
  },
  ...
  },
  {
    id: 'b-2',
    category: 'Budaya',
    question: 'Alat musik tradisional dari Jawa Barat yang terbuat dari bambu dan digoyangkan adalah...',
    options: ['Sasando', 'Gamelan', 'Angklung', 'Kolintang'],
    correctIndex: 2,
    explanation: 'Angklung telah diakui UNESCO sebagai Karya Agung Warisan Budaya Lisan dan Nonbendawi.'
  },
  {
    id: 'b-3',
    category: 'Budaya',
    question: 'Rumah adat khas Minangkabau yang beratap runcing menyerupai tanduk kerbau bernama...',
    options: ['Rumah Gadang', 'Rumah Joglo', 'Rumah Tongkonan', 'Rumah Honai'],
    correctIndex: 0,
    explanation: 'Rumah Gadang memiliki atap gonjong khas yang melambangkan keanggunan budaya Minangkabau.'
  },
  {
    id: 'b-4',
    category: 'Budaya',
    question: 'Tari Saman yang terkenal dengan gerakan serempak cepat berasal dari provinsi...',
    options: ['Sumatera Barat', 'Aceh', 'Riau', 'Jambi'],
    correctIndex: 1,
  ...
  },
  {
    ...
    options: ['Danau Maninjau', 'Danau Singkarak', 'Danau Toba', 'Danau Matano'],
    correctIndex: 2,
  ...
  },
  {
    ...
    options: ['Keris', 'Rencong', 'Mandau', 'Badik'],
    correctIndex: 2,
    explanation: 'Mandau merupakan pusaka pedang tradisional sakral khas suku Dayak.'
  }
];
...
/**
 * Mengambil daftar soal kustom yang dibuat pengguna dari localStorage
 */
...
/**
 * Menambahkan atau memperbarui soal kustom
 */
...
/**
 * Menghapus soal kustom berdasarkan ID
 */
